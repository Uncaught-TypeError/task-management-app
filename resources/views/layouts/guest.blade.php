...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <!-- Scripts -->
        @vite(['resources/css/app.css', 'resources/js/app.js', 'resources/css/styles.ss'])
    </head>
    <body class="font-sans text-gray-900 antialiased bg-gray-50">
            ...
            <nav class="bg-white border-gray-200 py-2.5">
                <div class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
                    <a href="#" class="flex items-center">
                        <span class="self-center text-3xl font-semibold whitespace-nowrap">TaskBoss</span>
                    </a>
                    <div class="flex items-center lg:order-2">
                        ...
                        @endif
                        <button data-collapse-toggle="mobile-menu-2" type="button" class="inline-flex items-center p-2 ml-1 text-sm text-gray-700 rounded-lg lg:hidden hover:bg-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-200" aria-controls="mobile-menu-2" aria-expanded="false">
                    ...
                    <div class="items-center justify-between hidden w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                        <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0 text-lg">
                            <li>
                                <a href="/" class="block py-2 pl-3 pr-4 text-gray-700 rounded lg:bg-transparent lg:p-0 border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-blue-500" aria-current="page">Home</a>
                            </li>
                            <li>
                                <a href="{{ route('front.task.index') }}" class="block py-2 pl-3 pr-4 text-gray-700 rounded lg:bg-transparent lg:p-0 border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-blue-500">Tasks</a>
                            </li>
                            <li>
        ...
        <footer class="bg-white border-t">
            <div class="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
                ...
                <div class="text-center">
                    ...
                    <span class="block text-sm text-center text-gray-500 ">© 2021-2022 TaskBoss™. All Rights Reserved. Built with <a href="https://flowbite.com" class="text-red-600 hover:underline ">Laravel</a> and <a href="https://tailwindcss.com" class="text-blue-600 hover:underline ">Tailwind CSS</a>. Created by <a href="https://themewagon.com/" class="text-yellow-600 hover:underline ">N.Dev</a>
                    </span>
        ...
        <script>
            window.addEventListener('beforeunload', function() {
                ...
                xhr.open('POST', '{{ route('track-time') }}');
