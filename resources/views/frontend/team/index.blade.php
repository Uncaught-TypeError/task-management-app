                    ...
                    <div class="my-8 divide-y-2 divide-gray-100 border-b border-gray-200">
                        <div class="flex flex-wrap py-8 md:flex-nowrap">
                            ...
                            <div class="md:flex-grow">
                                ...
                                @can('Team Up')
                                    <div class="flex justify-end">
                                        <a href="{{ route('team.invi', $user->id) }}" class="flex text-white bg-blue-400 border-0 py-2 px-3 focus:outline-none hover:bg-blue-500 rounded text-base">Team Up with {{ $user->name }}</a>
                                    </div>
                                @endcan
